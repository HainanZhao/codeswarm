...
| Live roster reconfiguration | Partial | Rust supports live `/add`, `/drop SLOT`, `/promote SLOT`, `/swap A B`, reload, stable slots, and healthy-peer continuation; catalog-driven live config remains unported. |
