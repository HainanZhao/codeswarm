...
| Persistent prompt/settings preferences | Partial | Roster, custom agents, prompt history, follow-tail, collapsed-details, notifications, and diff view persist; density/theme/tool preferences do not. |
