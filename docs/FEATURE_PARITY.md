...
| Rich Markdown/diff views | Partial | Tool payloads are retained for lazy expansion/export, unified patches are classified and colored by line, and basic Markdown headings/fences are styled; full Markdown layout/split panes remain intentionally unported. |
