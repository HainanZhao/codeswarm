...
| Live roster reconfiguration | Partial | Rust supports live `/add`, `/drop SLOT`, reload, stable slots, and healthy-peer continuation; owner transfer, catalog-driven live config, and in-place roster reordering remain unported. |
