...
from wingmen.acp.relay import AgentLike, RelayConversation, RelayResult
...
class SessionCoordinator:
    ...
    def set_turn_instructions(self, instructions: str) -> None:
        """Apply Wingmen-owned turn guidance to the current or future relay."""
    ...
    async def persist_roster(
        self, settings: SettingsStore, save_settings: SaveSettings
    ) -> None:
