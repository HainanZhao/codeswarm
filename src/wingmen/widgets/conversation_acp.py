...
from wingmen.acp import protocol as acp_protocol
from wingmen.acp.agent import parse_mode_update_notice
...
class ConversationACPHandlers(Widget):
    ...
    async def on_acp_tool_call_update(
        ...
        from wingmen.widgets.agent_response import AgentToolActivity
    ...
    async def set_mode(self, mode_id: str | None) -> None:
        ...
        if mode_id is not None and mode_id.startswith("wingmen:mode:"):
    ...
    async def request_permissions(
        ...
        if kind == "edit":
            ...
            if diffs:
                from wingmen.screens.permissions import PermissionsScreen
        ...
        from wingmen.widgets.acp_content import ACPToolCallContent
    ...
    def ask(
        ...
        from wingmen.widgets.question import Ask
