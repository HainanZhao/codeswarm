...
from wingmen.widgets.highlighted_textarea import HighlightedTextArea
from wingmen.widgets.condensed_path import CondensedPath
from wingmen.widgets.path_search import PathSearch
from wingmen.widgets.question import Ask, Question
from wingmen.widgets.slash_complete import SlashComplete
from wingmen.messages import UserInputSubmitted
from wingmen.slash_command import SlashCommand
from wingmen.prompt.extract import extract_paths_from_prompt
from wingmen.mode_policy import MODE_ORDER
...
class Prompt(containers.VerticalGroup):
    ...
    def watch_current_mode(self, mode: Mode | None) -> None:
        ...
        if mode is not None:
            ...
            label = (
                mode.name
                if mode.id.startswith("wingmen:") or not self.mode_owner
