...
class RelayConversation:
    ...
    def set_turn_instructions(self, instructions: str) -> None:
        """Set Wingmen-owned guidance applied to every future relay turn."""
        ...
        *,
        ...
        if can_stop:
            stop_instruction = (
                ...
                f"Wingmen displays {DEFAULT_STOP_ACKNOWLEDGMENT}. If you add "
        ...
        return (
            ...
            f"{work_instruction}\n\n"
            f"{stop_instruction}\n"
            "The token is internal: Wingmen hides it from the conversation."
        )
    ...
    def _unseen_updates(self, agent_index: int, *, excluding: int | None) -> str:
        ...
        if self._history_truncated[agent_index]:
            marker = "[Wingmen omitted older unseen updates to protect context.]"
