...
ACP_INITIALIZE: Final[bool] = _get_environ_bool("CODESWARM_ACP_INITIALIZE", True)
"""Initialize ACP agents?"""

ACP_INITIALIZE_TIMEOUT: Final[int] = _get_environ_int(
    "CODESWARM_ACP_INITIALIZE_TIMEOUT", 30, minimum=1
)
"""Maximum seconds to wait for an ACP agent to initialize."""
