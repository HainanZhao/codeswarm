...
from codeswarm.ansi._ansi_colors import ANSI_COLORS
from codeswarm.ansi._keys import TERMINAL_KEY_MAP, CURSOR_KEYS_APPLICATION
from codeswarm.ansi._control_codes import CONTROL_CODES
from codeswarm.ansi._sgr_styles import SGR_STYLES
from codeswarm.ansi._stream_parser import (
    StreamParser,
    SeparatorToken,
    PatternToken,
    Pattern,
...
from codeswarm.dec import CHARSET_MAP
...
@rich.repr.auto
class ANSINewLine:
    """New line (different in alternate buffer)."""
