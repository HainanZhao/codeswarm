"""Agent-independent permission policies for a CodeSwarm roster."""
...
STARTUP_FULL_ACCESS_MODE = Mode(
    "codeswarm:startup-full-access",
    "Auto pilot",
...
class ModePolicy:
    """A CodeSwarm-level intent and the adapter names known to implement it."""
...
DEFAULT_MODE_POLICY_ID = "codeswarm:mode:full-access"
MODE_ORDER = {
    "codeswarm:discuss": 0,
