...
SCHEMA: list[SchemaDict] = [
    ...
    },
    {
        ...
        "help": "Customize how Taiji displays notifications",
        "type": "object",
        "fields": [
            {
                "key": "system",
        "title": "Show Taiji notifications on your desktop?",
                "type": "choices",
                "default": "blur",
                "choices": [
                    ("Never", "never"),
    ...
    },
    {
        ...
        "help": "Customize how Taiji displays agent tool calls",
        "type": "object",
        "fields": [
            {
                "key": "expand",
                "title": "Tool call expand",
                "help": "When should Taiji expand tool calls?",
                "type": "choices",
                "default": "fail",
                "choices": [
                    ("Never", "never"),
    ...
    },
    {
        ...
        "fields": [
            ...
            },
            {
                ...
                "help": "If enabled, Taiji will highlight potentially destructive commands that may modify the filesystem outside of the project directory.\n\nNote that false positive [i]and[/] false negatives are possible.",
                "type": "boolean",
                "default": True,
            },
            {
        ...
        "fields": [
            {
                ...
                "help": "Taiji can collect basic usage data (number of installs, OS version, agents used, session length etc). This information is associated with a randomly generated UUID (see it in /about:toad) and contains no personal information.\n\nCollecting this information will help me (Will McGugan) convince big tech to take this project seriously. I would appreciate if you left this on, but it is entirely up to you.",
                "type": "boolean",
                "default": True,
            },
        ],
